...
public class LocationServlet extends HttpServlet {
    ...
    IGeneralDAO<Location> iGeneralDAO = new GeneralDAO<>(Location.class, HibernateUtil.getSessionFactory());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.getSession().setAttribute("dataLocation", iGeneralDAO.getData("", false));
            response.sendRedirect("location/location.jsp");
...
//        if (iGeneralDAO.saveOrDelete(new Location((0), name), true)){
//        
//        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (iGeneralDAO.saveOrDelete(new Location(Short.valueOf(id), address, postal, cty, province, new Country(cid)), true)){
            processRequest(request, response);
        }
    }
