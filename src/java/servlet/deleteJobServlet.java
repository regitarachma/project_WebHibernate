...
IGeneralDAO<Job> jao = new GeneralDAO<>(Job.class, HibernateUtil.getSessionFactory());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String jmin = request.getParameter("jmin");
        String jmax = request.getParameter("jmax");
        if (jao.saveOrDelete(new Job(jid, jname, Integer.parseInt(jmin), Integer.parseInt(jmax)), false)) {
