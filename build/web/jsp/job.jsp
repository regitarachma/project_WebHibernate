...
<html>
                    ...
                    <tbody align="center">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete-job<%= j.getJobId()%>">Delete</a>
                            </td>
                        </tr>   
                        <% }%>
                    </tbody>
    ...
    <!--modal edit job-->
    <%for (Job j : list) {%>
    <div class="modal fade" id="edit-job<%= j.getJobId()%>" role="dialog" aria-labelledby="confirmDeleteLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="../JobServlet" method="get">
                    <div class="modal-body">
                        <input type="hidden" class="form-control" id="job_id" name="job_id" value="<%= j.getJobId()%>">
                        <div class="form-group">
                            <input type="text" class="form-control" id="job_title" name="job_title" value="<%= j.getJobTitle()%>" required placeholder="Enter Job Title">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" id="min_sal" name="min_sal" value="<%= j.getMinSalary()%>" required placeholder="Enter Minimal Salary">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" id="max_sal" name="max_sal" value="<%= j.getMaxSalary()%>" required placeholder="Enter Maximal Salary">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
    ...
    <% }%>
    <%for (Job j : list) {%>
    <div class="modal fade" id="delete-job<%= j.getJobId()%>" role="dialog" aria-labelledby="confirmDeleteLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="../deleteJobServlet" method="get">
                    <div class="modal-body">
                        <input type="hidden" class="form-control" id="job_id" name="job_id" value="<%= j.getJobId()%>">
                        <input type="hidden" class="form-control" id="job_title" name="job_title" value="<%= j.getJobTitle()%>">
                        <input type="hidden" class="form-control" id="min_sal" name="min_sal" value="<%= j.getMinSalary()%>">
                        <input type="hidden" class="form-control" id="max_sal" name="max_sal" value="<%= j.getMaxSalary()%>" required placeholder="Enter Maximal Salary">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
