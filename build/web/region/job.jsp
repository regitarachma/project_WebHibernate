...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="card border-info">
                <div class="card-header bg-info text-white">
                    ...
                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#insert-job">
                        Tambah Data Job
                    </button>
                </div>
                <div class="card-body">
                        ...
                        <!--<c:forEach var="datas" items="${list}">-->
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a type="button" class="btn btn-warning" data-toggle="modal" data-target="#edit-job<%= job.getJobId()%>">Edit</a>
        ...
        <!--modal insert job-->
        <div class="modal fade" id="insert-job" role="dialog" aria-labelledby="confirmDeleteLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Insert Job</h4>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="../deleteJobServlet" method="get">
                        <div class="modal-body">
                            <input type="hidden" class="form-control" id="job_id" name="job_id" value="<%= job.getJobId()%>">
                            <input type="hidden" class="form-control" id="job_title" name="job_title" value="<%= job.getJobTitle()%>">
                            <input type="hidden" class="form-control" id="min_sal" name="min_sal" value="<%= job.getMinSalary()%>">
                            <input type="hidden" class="form-control" id="max_sal" name="max_sal" value="<%= job.getMaxSalary()%>" required placeholder="Enter Maximal Salary">
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
